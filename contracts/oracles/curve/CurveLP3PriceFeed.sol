...
/// @title CurveLP pricefeed for 3 assets
contract CurveLP3PriceFeed is AggregatorV3Interface {
        ...
        )
    {
        ...
        answer = (answer * int256(curvePool.get_virtual_price())) / 10**18; // F:[OCLP-5]
    }
}
